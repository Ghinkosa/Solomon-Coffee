  ...
  return (
    <section className="relative min-h-[320px] w-full overflow-hidden sm:min-h-[380px]">
      ...
      <div className="relative z-10 mx-auto max-w-4xl px-4 py-16 text-center sm:px-6 lg:py-20">
        <h3 className="mb-4 font-serif text-3xl font-bold leading-tight text-shop_light_pink sm:text-4xl lg:text-5xl">
          Brew Better at Home with Sheba Cup Coffee
        </h3>
        <p className="mx-auto mb-8 max-w-2xl text-base leading-relaxed text-shop_light_pink/90 sm:text-lg">
          Explore fresh roasts, brewing essentials, and limited selections
          crafted for your daily ritual.
        </p>
        <Link
          href={`/${lang}/shop`}
          className="inline-flex items-center gap-2 rounded-full border border-shop_orange bg-shop_orange px-7 py-3.5 text-sm font-semibold text-shop_dark_green transition-colors hover:border-shop_light_pink hover:bg-shop_light_pink sm:text-base"
        >
          Shop Coffee
          <ArrowRight size={16} />
        </Link>
