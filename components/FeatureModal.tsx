      ...
      {isOpen && (
        <>
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 pointer-events-none">
            ...
            >
              {/* Header */}
              <div className="relative bg-linear-to-br from-shop_light_bg via-shop_light_pink to-shop_light_green p-6 lg:p-8">
                <button
                  onClick={onClose}
                  ...
                  <div className="space-y-3">
                    {feature.details.map((detail, index) => (
                      <motion.div
                        ...
                        className="flex items-start gap-3 p-4 bg-linear-to-r from-shop_light_bg to-white rounded-xl border border-shop_light_green/20 hover:border-shop_light_green hoverEffect"
                      >
                        <div
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    {feature.benefits.map((benefit, index) => (
                      <motion.div
                        ...
                        className="flex items-start gap-3 p-3 bg-white rounded-xl border border-gray-100 hover:border-shop_light_green hover:shadow-md hoverEffect"
                      >
                        <Check
              ...
              {/* Footer */}
              <div className="bg-linear-to-r from-shop_light_bg to-shop_light_pink border-t border-shop_light_green/20 p-2">
