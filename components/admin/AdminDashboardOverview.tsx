              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="text-center">
                  <div className="flex items-center justify-center mb-3">
                    <div className="relative w-12 h-12 rounded-xl bg-linear-to-br from-amber-500 to-orange-600 flex items-center justify-center">
                      <div
                        className={`absolute -inset-2 bg-linear-to-br from-amber-500 to-orange-600 opacity-0 group-hover:opacity-20 blur-xl rounded-full transition-opacity duration-300`}
                      />
                ...
                <div className="text-center">
                  <div className="flex items-center justify-center mb-3">
                    <div className="w-12 h-12 rounded-full bg-linear-to-br from-shop_light_green to-shop_dark_green flex items-center justify-center text-white shadow-lg mb-4">
                    ...
                    <CardContent className="p-6">
                      <div className="space-y-4">
                        <div className="flex items-center justify-between">
                          <div
                            className={`p-3 rounded-xl bg-linear-to-br ${action.color} text-white shadow-lg group-hover:scale-110 transition-transform duration-300`}
                          >
