...
const HelpPage = () => {
  ...
  const helpCategories = [
    ...
    },
    {
      ...
      icon: RotateCcw,
      description: "How we handle damaged, incorrect, or quality-related coffee issues",
      color: "from-dark-red to-light-orange",
      links: [
        { title: "Quality Promise", href: "/faq#returns-1" },
        { title: "Report an Order Issue", href: "/faq#returns-2" },
        { title: "Resolution Timeline", href: "/faq#returns-3" },
  ...
  const quickActions = [
    ...
    {
      title: "Report an Order Issue",
      description: "Tell us if your order arrived damaged, incorrect, or below quality standards",
      icon: RotateCcw,
      action: "Report Issue",
      href: "/orders",
      color: "bg-dark-blue",
